...
namespace Todos
{
    public sealed partial class MainPage : Page
    {
        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            var item = ToDoListView.ContainerFromItem(dc) as ListViewItem;
            ViewModel.SelectedItem = (Models.TodoItem)(item.Content);
            ViewModel.DeleteDatabase(ViewModel.SelectedItem.GetId());
        ...
        private void UpdateButton_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            {
                ViewModel.UpdataDatabase(title_MainPage.Text, description_MainPage.Text, DatePicker_MainPage.Date.ToString(), ViewModel.SelectedItem.GetId(), ViewModel.SelectedItem.completed);
        ...
        {
            using (var statement = db.Prepare("SELECT * FROM Todos where title like '%"+SearchBox.Text+"%' or detail like '%"+SearchBox.Text+"%' "))
            {
                ...
                while (SQLiteResult.DONE != statement.Step())
                {
                    ...
                    MyStringBuilder.Append("Title:  " + title + " Description: " + detail + " Time: " + time + "\n");
                }
                if (MyStringBuilder.ToString() != "")
                {
                    var i = new MessageDialog(MyStringBuilder.ToString()).ShowAsync();
                }
                else
                {
                    var i = new MessageDialog("没有包含  \"" + SearchBox.Text + "\"  字符串的项").ShowAsync();
                }
            }
        }
        ...
        {
            Frame.Navigate(typeof(LifePage));
        }
    }
}
